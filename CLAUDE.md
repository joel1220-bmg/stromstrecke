...
# Stromstrecke — working agreement

> **Formerly "Fahrklar".** The site was renamed on 13.09.2026 because that name
> was already taken; it lives at stromstrecke.de. The GitHub repository
> (joel1220-bmg/stromstrecke) and the npm package followed on 22.09.2026.
> Two things still say fahrklar on purpose: the localStorage keys
> `fahrklar-draft-v1` and `fahrklar-remember-v1`, because renaming them would
> throw away every draft a reader asked us to keep, and the local folder
> `C:\Users\joeli\fahrklar` on the development machine. Do not "tidy" the keys.
